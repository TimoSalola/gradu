...
\ffigbox{%
  	...
  	\caption{10000 point exhaustive search on 15 cloud free days from FMI Helsinki dataset using year 2018.}
...
\ffigbox{%
  ...
  \caption{10000 point exhaustive search on 8 cloud free days from FMI Helsinki dataset using year 2019.}
  \label{fig_fmi_helsinki_1000_multi_day_2020}
}
\end{floatrow}
\end{figure}

Results for the Kuopio dataset are not nearly as good as the Helsinki predictions. Figures \ref{fig_fmi_kuopio_10000_multi_day_2018} and \ref{fig_fmi_kuopio_10000_multi_day_2020} clearly indicate that estimations are converging several degrees off from the known installation angles.


%In the more dense 10000 point lattice used for the year 2017 the mean of tilt and azimuth predictions is 26.76$^\circ$ and 201.11$^\circ$, resulting in a center angle delta of 13$^\circ$. 
...
\ffigbox{%
  ...
  \caption{10000 point exhaustive search on 18 cloud free days from FMI Kuopio dataset using year 2018.}
...
\ffigbox{%
  ...
  \caption{1000 point exhaustive search on 10 cloud free days from FMI Kuopio dataset using year 2020.}
