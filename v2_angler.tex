...
\begin{enumerate}
  ...
  \item Choose a starting point for the iterative algorithm from the angle space. This can be either the best result from a low density lattice or a fixed point such as tilt 45$^\circ$ azimuth 180$^\circ$.
  \item Evaluate the fitness at the starting point and store that as the center point fitness.
