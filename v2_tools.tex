...
DNI_{reflected}= exp(-\frac{1}{a_r}(c_1 p +c_2 p^2))
\end{split}
\end{equation}

\noindent Where

$p= sin(tilt) + \frac{tilt-sin(tilt)}{1-cos(tilt)}$
