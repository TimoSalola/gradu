...
For unknown PV systems, the unknown value $P_{rated}$ can be estimated with area matching. This is the process of calculating the integral or sum of power generation plots and matching their values. A 1kW system can be matched. Visualization of this process where a POA simulation of a 1kW installation is area matched with known measurement data is shown in Figure \ref{fig_area_match}.
